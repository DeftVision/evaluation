...
exports.newEvaluation = async (req, res) => {
    try {
        ...
        const evaluation = new evaluationModel({visitDateTime, evaluator, location, cashier, greeting, repeatOrder, upsell, patio, wait, foodScore, cleanScore, serviceScore, calculateScore, image, identifyManager, comments })
